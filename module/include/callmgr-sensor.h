...
#ifndef __CALLMGR_SENSOR_H__
#define __CALLMGR_SENSOR_H__

#include <glib.h>

typedef enum {
	CM_SENSOR_EVENT_TURN_OVER_E,

} cm_sensor_event_type_e;

typedef struct __sensor_data *callmgr_sensor_handle_h;
typedef void (*cm_sensor_event_cb) (cm_sensor_event_type_e event_type, void *event_data, void *user_data);
